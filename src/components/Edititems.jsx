...
const Edititems = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://adda-ghor-backend-e7uhx4v5w-tr-tauhids-projects.vercel.app/editItems", {
      method: "POST",
      headers: {
  ...
  const handleUpdateItemForm = (e) => {
    ...
    fetch(`https://adda-ghor-backend-e7uhx4v5w-tr-tauhids-projects.vercel.app/editItems/${updatingItem?._id}`, {
      method: "PUT",
      headers: {
        "content-type": "application/json",
      },
      ...
      .then((result) => {
        if (result.modifiedCount === 1) {
          ...
          fetch("https://adda-ghor-backend-e7uhx4v5w-tr-tauhids-projects.vercel.app/menus")
            .then((res) => res.json())
            .then((data) => {
              setMenuItem(data);
            });
  ...
  const deleteItem = (_id) => {
    swal({
      ...
      if (willDelete) {
        fetch(`https://adda-ghor-backend-e7uhx4v5w-tr-tauhids-projects.vercel.app/editItems/${_id}`, {
          method: "DELETE",
        })
          .then((res) => res.json())
          .then((data) => {
